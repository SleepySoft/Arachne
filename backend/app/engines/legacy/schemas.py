...
These models define the node/edge types, enums, and request/response shapes
for the original Neo4j-backed industrial graph engine. Shared primitives
(Confidence, NodeStatus, Evidence) are imported from app.models.core.
"""
...
from app.models.core import Confidence, Evidence, NodeStatus, RecordStatus

# -*- coding: utf-8 -*-
"""
Legacy-engine database checkers and cleanup tools.

These checkers operate directly on the original Neo4j :IndustrialNode,
:INDUSTRIAL_FLOW, and :ONTOLOGY storage layout and are therefore part of the
legacy engine policy layer. New checkers that target a different storage model
should live in the corresponding engine's policy module.

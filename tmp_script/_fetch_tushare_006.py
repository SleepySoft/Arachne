...
with open('data/stock_batches/batch_006.json', 'r', encoding='utf-8') as f:
...
with open('tmp_script/tushare_006_data.json', 'w', encoding='utf-8') as f:
    json.dump(results, f, ensure_ascii=False, indent=2)

print("Saved to tmp_script/tushare_006_data.json")
